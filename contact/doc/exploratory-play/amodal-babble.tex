...
More formally, if we have motor control variables $M=<m_1,m_2,...,m_N>$ and
sensor variables $S=<s_1,s_2,...,s_n>$, 
with some chosen feature $f(S)$,
then we attempt to find an $M$ to

searching for some configuration $C=<m_1,m_2,...,m_N>$
to maximise:
